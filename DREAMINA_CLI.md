...
> Версия билда: `5a448f5` (2026-04-07)
...
> VIP-модели теперь явно в `--help` начиная с CLI `5a448f5` (2026-04-07). Правильные имена: `seedance2.0_vip` и `seedance2.0fast_vip` (с подчёркиванием перед `vip`). Старые имена `seedance2.0vip` / `seedance2.0fastvip` (без подчёркивания) — **неправильные**: CLI принимал без ошибки, но API игнорировал и ставил в стандартную очередь. Нужен VIP-аккаунт.
...
**Доступные модели:** `3.0`, `3.0fast`, `3.0pro`, `3.5pro`, `seedance2.0`, `seedance2.0fast`, `seedance2.0_vip`, `seedance2.0fast_vip`
...
**Варианты и цены (проверено 2026-04-07 из live API):**
| Резолюция | Кредиты | Доступ |
|---|---|---|
| `2k` | 1 | Все пользователи |
| `4k` | 2 | VIP |
| `8k` | ? | VIP (не тестировали) |
